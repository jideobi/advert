...
const Na = () => {
  ...
  return (
    <div className="fixed  w-full h-[100px] flex justify-between items-center  px-4 text-[#0a192f] shadow-lg shadow-cyan-500/50  bg-gradient-to-r from-green-400 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
      <div className="">
